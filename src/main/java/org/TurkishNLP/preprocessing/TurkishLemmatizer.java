...
public class TurkishLemmatizer {
    ...
    public TurkishLemmatizer() throws IOException {
    ...
    public void processFile(String filepath, Path outPath, boolean inMem) throws IOException {
...
//        Timer.setTimer();
        ...
        if(inMem) {
            ...
            cleaned = TextCleaner.cleanFileInMemory(filepath);
            if (cleaned == null) return;
        } else {
            log.info("Cleaning the text on disk...");
//            tempPath = TextCleaner.cleanFileOnDisk(filepath);
...
//        TurkishLemmatizer pp = new TurkishLemmatizer();
