...
public class Dictionary {
    ...
    // Process zemberek's default dictionary
    ...
    public static HashMap<String, Long> trimDefaultDictionaryWithCorpus(int maxFreq, File corpusFile) {
        try {
    ...
    public static void main(String[] args) throws IOException{
        Dictionary.trimDefaultDictionaryWithCorpus(5, Paths.get("data\\processed_files\\short_corpus.processed2").toFile());
//        Dictionary.processDefaultDictionary();
    }
}
